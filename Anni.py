...
try:
    app=wolframalpha.Client("P984UP-45992WHJGL")  #API key for wolframalpha
...
def greet():
    ...
    conn.commit()
    conn.close()
    SR.speak("\nMyself Anni. How may I help you?")
    ...
    try:
        while(True):
            ...
            #jokes
                            ...
                            'would like to hear some jokes','tell me more jokes','jokes', 'joke'],query):
            ...
            #asking for name
                ...
                SR.speak("My name is anni and I'm here to serve you.")
            #How are you
            ...
            elif there_exists(["what is my exact location","What is my location","my current location","my exact current location"],query):
            ...
            # top 5 news
            elif there_exists(['top 5 news','top five news','listen some news','todays day','news'],query):
                news=Annex.News(scrollable_text)
                news.show()

            #whatsapp message
            elif there_exists(['open whatsapp messaging','send a whatsapp message','send whatsapp message','please send a whatsapp message'],query):
            ...
            #play game
            elif there_exists(['would like to play some games','games','play some games','would like to play some game','want to play some games','want to play game','want to play games','play games','open games','play game','open game'],query):
            ...
            #opening software applications
                ...
                codepath=r"C:\Users\yasaswini\AppData\Local\Programs\Microsoft VS Code\Code.exe"
                ...
                os.startfile(r'C:\Users\yasaswini\AppData\Local\WhatsApp\WhatsApp.exe')
                break
                ...
                break
            elif there_exists(['open songs','music player','spotify'],query):
                SR.speak("Opening songs in spotify player")
                os.startfile(r"C:\Users\yasaswini\AppData\Roaming\Spotify\Spotify.exe")
                break
...
if __name__=="__main__":
        ...
        root.geometry("{}x{}+{}+{}".format(1366,768,int(root.winfo_screenwidth()/2 - 1366/2),int(root.winfo_screenheight()/2 - 768/2)))
        root.resizable(0,0)
        root.title("ANNI")
        root.iconbitmap('anni.ico')
        root.configure(bg='#2c4557')
        scrollable_text=scrolledtext.ScrolledText(root,state='disabled',height=20,width=137,relief='sunken',bd=15,wrap=tk.WORD,bg='#add8e6',fg='#800000')
        scrollable_text.place(x=100,y=100)
        mic_img=Image.open("Mic.png")
        mic_img=mic_img.resize((75,75),Image.ANTIALIAS)
        mic_img=ImageTk.PhotoImage(mic_img)
        Speak_label=tk.Label(root,text="SPEAK:",fg="#FFD700",font='"Times New Roman" 35 ',borderwidth=0,bg='#2c4557')
        Speak_label.place(x=550,y=500)
        """Setting up objects"""
        ...
        Listen_Button.place(x=730,y=480)
        myMenu=tk.Menu(root)
